...
def fbconnect():
    ...
    app_id = json.loads(open('/var/www/msc/fb_client_secrets.json').read())['web']['app_id']
    app_secret = json.loads(open(
        '/var/www/msc/fb_client_secrets.json').read())['web']['app_secret']
...
def gconnect():
    ...
    try:
        ...
        oauth_flow = flow_from_clientsecrets('/var/www/msc/client_secrets.json', scope='')
